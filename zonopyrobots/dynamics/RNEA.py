...
from zonopyrobots.util import make_cfg_dict
...
def pzrnea(rotatotopes: Union[Dict[str, Union[MPZType, BMPZType]], List[Union[MPZType, BMPZType]], None],
           qd: Union[Dict[str, Union[PZType, BPZType]], List[Union[PZType, BPZType]], None],
           qd_aux: Union[Dict[str, Union[PZType, BPZType]], List[Union[PZType, BPZType]], None],
           qdd: Union[Dict[str, Union[PZType, BPZType]], List[Union[PZType, BPZType]], None],
           robot: ZonoArmRobot,
           zono_order: int = 40,
    ...
    Args:
        rotatotopes (Union[Dict[str, Union[matPolyZonotope, batchMatPolyZonotope]], List[Union[matPolyZonotope, batchMatPolyZonotope]], None]):
            ...
            If not provided, it will use the identity matrix for each joint.
        qd (Union[Dict[str, Union[polyZonotope, batchPolyZonotope]], List[Union[polyZonotope, batchPolyZonotope]], None]):
            ...
            If not provided, it will use 0 for each joint.
        qd_aux (Union[Dict[str, Union[polyZonotope, batchPolyZonotope]], List[Union[polyZonotope, batchPolyZonotope]], None]):
            ...
            If not provided, it will use the same value as `qd`.
        qdd (Union[Dict[str, Union[polyZonotope, batchPolyZonotope]], List[Union[polyZonotope, batchPolyZonotope]], None]):
    ...
    for lnk in urdf._reverse_topo:
        ...
        joint_vel_aux = qd_aux_map.get(name, joint_vel)
